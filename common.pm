...
sub parse_date($) {
    my $time = shift;
    my $date = scalar gmtime($time + ( TIME_ZONE * 3600 )); # By hours
...
sub redirect($$$$$$) {
    ...
    , '<meta http-equiv="refresh" content="' . REDIRECT_DELAY . ';'
    , ' url=' . $dir . '">'
    , '</head><body>Updating...</body></html>'
    ;
}
